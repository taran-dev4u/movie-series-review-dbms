...
$review_str = "SELECT review_rating, review_description FROM $tblReviews WHERE reviews.review_movie_id=" . $id . "";
...
//	$review_result_row = $review_result->fetch_assoc();
	...
	$page_title = "Taran Mamidala " . $result_row['movie_name'];
		...
		<div class="col-xs-8">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<p class="lead"><?php echo $result_row['movie_overview'] ?></p>
					<?php for ($i = 0; $i < 5; $i++ ) :
					...
					<p class="lead">Review: <br/><?php echo $review_result_row['review_description'] ?></p>
					<?php endwhile; endfor;  ?>
				</div>
			</div>
				<p>
